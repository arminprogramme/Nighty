...
let titleProductList = document.querySelector('#title-product-page')
...
function getProductList() {
    ...
    titleProductList.innerHTML = titleURL


    fetch(`${mainURL}product/getListProduct/${idURL}`)
        .then(res => res.json())
        .then(data => {
            //console.log(data);
            productListContainer.innerHTML = ''
            data.forEach(product => {
                productListContainer.insertAdjacentHTML('afterbegin', `
                <div class=" w-full product-item py-3">
                <a href="productInfo.html?title=${product.url}">
                    <div class="photo ">
                        <img src="${product.img_2}" class="w-full ">
                    </div>
